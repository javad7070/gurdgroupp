...
من گارد گروپ هستم یک نگهبان همیشه آنلاین برای گروهتون کافیه منو اد کنید تو گروهتون و منو مدیر کنید.
]])
	elseif key == 'all' then
		return _([[
*دستورات برای همه*:
...
به مدیر پیام بدید, اگه مشکلی دارید [مدیر ربات](https://telegram.me/javad7070).
]])
...
اگه زبانی دوست داشتید که در ربات نبود بما اطلاع دهید [مدیر ربات](https://telegram.me/javad7070) .
